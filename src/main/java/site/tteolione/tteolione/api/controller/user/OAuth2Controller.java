...
public class OAuth2Controller {
    ...
    @PostMapping("/kakao")
    public BaseResponse<LoginRes> kakaoLogin(@RequestBody OAuth2KakaoReq request) {
    ...
    public BaseResponse<LoginRes> kakaoSignup(@RequestPart(value = "profile") MultipartFile profile,
                                                   @RequestPart(value = "request") OAuth2KakaoReq request) {
